...
public class UI_Main extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("TiendaOnline.co");
        ...
        jLabel4.setText("Ir al carrito de compras:");
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        Buscar_prod bp = new Buscar_prod();
        Buscar_prod.LabeldeBusqueda.setText(jLabel7.getText());
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
      if(jLabel7.getText().isEmpty()){
            ...
            Carrito.jLabel3.setText(jLabel7.getText());
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
       Vender_prod venta = new Vender_prod();
