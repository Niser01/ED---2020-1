...
Producto[] arr = new Producto[lenght];
    
    public Buscar_prod_resultados() {
        initComponents();
         this.setLocation(400, 170);
    }
    public void propiedadesLista(){
        
    }
    
    public void print(Producto[] arreglo){
        //jList1.setPrototypeCellValue(Object.class,new imgLista());
        DefaultListModel modelo = new DefaultListModel();
        jList1.setModel(modelo);
    
        /*File ruta = new File("src/Imagenes/Pen.png");
        Image imagen=null;
        try{
        ...
        for(int i = 0; i< arreglo.length;i++){
            ...
            //modelo.addElement(new Object(new JLabel(new ImageIcon(getClass().getResource("src/Imagenes/Pen.png")))));
            modelo.addElement(" ");
    ...
    public void agregarCarro(Producto[] arreglo){
        ...
        if(jLabel2.getText().isEmpty()){
            ...
            int cant = Integer.parseInt(JOptionPane.showInputDialog("¿Cuantos productos desea?"));
            ...
            if(cant == 1){
                ...
                for(int i = 0; i<cant;i++){
                    int id = arreglo[i].getId();
                    NodoArbol busqueda =arbolProductos.buscar(id, arbolProductos.getRaiz());
                    envio.añadir_al_carrito((Producto)busqueda.getValor());
                }
                JOptionPane.showMessageDialog(null, "Productos añadidos al carrito");
            }
