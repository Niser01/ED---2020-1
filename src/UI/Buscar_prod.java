...
import estructurasproyecto.HashTable;
...
public class Buscar_prod extends javax.swing.JFrame {
  ...
  //  static ListaEnlazada<Producto> productos = new ListaEnlazada<>();
    ...
    static HashTable tablaProductos = new HashTable();
   ...
   public void  leer(){
            ...
            if (archivo.exists()){
                ...
                while(flujoEntrada.hasNextLine()){
                   ...
                   // productos.add(producto);
                    ...
                    tablaProductos.insertar(producto);
                }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if(arbolProductos.getRaiz()== null){
            leer(); 
            System.out.println("numtable"+tablaProductos.getSize());
        }else{ 
            long inicio = System.currentTimeMillis(), fin;
            double tiempo;    
            int resultado =0;
            ...
            if(busqueda.isEmpty()){
                ...
                ListaEnlazada<Producto> prod = new ListaEnlazada();
                prod= tablaProductos.buscar(busqueda);
                resultado=prod.getSize();
                fin = System.currentTimeMillis();
                tiempo = (double)((fin-inicio));
                System.out.println("Restultados de la búsqueda:"+resultado);
                System.out.println("tiempo para ejecutar la busqueda:"+tiempo+"milisegundos");
             
             
            Producto[] info_filtrada = new Producto[resultado];
        
            for(int j=0;j<resultado;j++){
                info_filtrada[j]=prod.obtener(j);
            }
