...
public class Vender_prod extends javax.swing.JFrame {
        ...
        if(productos.getSize()== 0){
           leer(); 
            ...
            try{
                    ...
                    FileWriter fw = new FileWriter("Datos10000.csv",true);
                    Producto prod = new Producto(productos.getSize()+1,nombre,marca, referencia,precio);
                    productos.add(prod);
                    PrintWriter pw = new PrintWriter(fw);
                    pw.print("\n"+prod.getId()+";"+prod.getNombre()+";"+prod.getMarca()+";"+prod.getReferencia()+";"+prod.getPrecio());
                    pw.flush();
                    pw.close();
                    fw.close();
                    JOptionPane.showMessageDialog(null, "El producto ha sido vendido. El Id asignado es: "+ prod.getId());
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Vender un producto:");

        jLabel2.setText("Ingrese la informacion del producto que desea incluir:");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Vender_prod.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Vender_prod().setVisible(true);
            }
        });
    }
